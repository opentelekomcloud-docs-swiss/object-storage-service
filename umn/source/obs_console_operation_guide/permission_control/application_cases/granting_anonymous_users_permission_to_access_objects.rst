...
#. Under **Object ACL** > **Public Permissions** > **Anonymous User**, click **Edit** and set **Access to Object** to **Read** to grant the object read permission for anonymous users.
